...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        # Compute gradients
        output_layer_error = -(y - activated_output)*np.vectorize(output_layer_activation_derivative)(output)# TODO
        ...
        hidden_to_output_weight_gradients = np.matmul(output_layer_error,hidden_layer_activation.T) # TODO
        input_to_hidden_weight_gradients = np.matmul(hidden_layer_error,input_values.T) # TODO
    ...
    def predict(self, x1, x2):
        ...
        output = output = self.hidden_to_output_weights.dot(hidden_layer_activation)# TODO
        activated_output = np.vectorize(output_layer_activation)(output)# TODO
